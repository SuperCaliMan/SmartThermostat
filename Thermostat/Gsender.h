...
class Gsender
{
    ...
    private:
        ...
        const char* EMAILBASE64_LOGIN = "***********************"; //set yout email here http://www.instructables.com/id/ESP8266-GMail-Sender/      this words are encoded with this tool https://www.base64encode.org/
        const char* EMAILBASE64_PASSWORD = "********************"; // http://www.instructables.com/id/ESP8266-GMail-Sender/     this words are encoded with this tool https://www.base64encode.org/
